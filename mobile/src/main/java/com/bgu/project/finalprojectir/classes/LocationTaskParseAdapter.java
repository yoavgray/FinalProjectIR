 ...
 */
public class LocationTaskParseAdapter extends ParseQueryAdapter<ParseTask>{

    public LocationTaskParseAdapter(Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<ParseTask>() {
            public ParseQuery<ParseTask> create() {
                ...
                query.whereEqualTo("type","location");
